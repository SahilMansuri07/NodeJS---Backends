...
const fr = require('../language/fr.js');
...
const allowRolles  = (...roles ) => {
    return (req , res , next) => {
        ...
        if(!roles.includes(req.loginUser.role)){
            return sendResponse(req ,res , 401, -1 , { keyword: "Access_Denied" , component : {} })
        }
        next();
    }
}
...
module.exports = { checkApi, sendResponse, allowRolles , encryption  , validateJoi, checkToken , getMessage ,decryption }