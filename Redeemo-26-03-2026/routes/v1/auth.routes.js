...
// ─── SIGNUP ───────────────────────────────────────────────────────────────────
userAuthRoute.post('/signup', checkApi, validateJoi(joi.object({
...
// ─── VERIFY OTP ───────────────────────────────────────────────────────────────
userAuthRoute.post('/verifyOtp', checkApi, validateJoi(joi.object({
...
// ─── RESEND OTP ───────────────────────────────────────────────────────────────
userAuthRoute.post('/resendOtp', checkApi, validateJoi(joi.object({
    mobile: joi.string().pattern(/^\d{6,15}$/).trim().required(),
    country_code: joi.string().pattern(/^\+\d{1,4}$/).trim().required(),
...
// ─── FORGET PASSWORD ──────────────────────────────────────────────────────────
userAuthRoute.post('/forgetpass', checkApi, validateJoi(joi.object({
    mobile: joi.string().pattern(/^\d{6,15}$/).trim().required(),
    country_code: joi.string().pattern(/^\+\d{1,4}$/).trim().required()
...
// ─── FORGET OTP VERIFY ────────────────────────────────────────────────────────
userAuthRoute.post('/forgetOtpVerify', checkApi, validateJoi(joi.object({
    mobile: joi.string().pattern(/^\d{6,15}$/).trim().required(),
    otp: joi.string().length(6).required()
...
userAuthRoute.post('/updatePass', checkApi, validateJoi(joi.object({
...
userAuthRoute.post('/setUserDetails', checkApi, validateJoi(joi.object({
    user_id: joi.number().integer().positive().required(),
...
userAuthRoute.post('/signIn', checkApi, validateJoi(joi.object({
...
// ─── CHANGE PASSWORD ──────────────────────────────────────────────────────────
userAuthRoute.post('/changePassword', checkApi, checkToken, validateJoi(joi.object({
...
// ─── SET INTERESTS ────────────────────────────────────────────────────────────
userAuthRoute.post('/setInterest', checkApi, checkToken, validateJoi(joi.object({
    user_id: joi.number().integer().positive().required(),
...
// ─── SET PROFILE DETAILS ──────────────────────────────────────────────────────
userAuthRoute.put('/setprofileDetails', checkApi, checkToken, validateJoi(joi.object({
...
userAuthRoute.post("/updateInterests", checkApi, checkToken,validateJoi(joi.object({
...
adminAuthRoute.post("/signIn", checkApi, validateJoi(joi.object({
